...
% ═══════════════════════════════════════════════════════════════
\clearpage
\part{\texorpdfstring{The Three Functors: Pascal, Modular, and Clifford Unite at $q=3$}{The Three Functors: Pascal, Modular, and Clifford Unite at q=3}}

\section{\texorpdfstring{$E_8$ from the Clifford Algebra $\Cl(q)$}{E8 from the Clifford Algebra Cl(q)}}
...
\section{\texorpdfstring{Bott Periodicity: The Period is $2^q$}{Bott Periodicity: The Period is 2 to the q}}
\label{sec:bott}
...
\section{\texorpdfstring{The Modular Functor: SU(2)${}_q$ Chern--Simons}{The Modular Functor: SU(2) at level q Chern-Simons}}
...
\section{\texorpdfstring{$q$-Deformed Rationals and Knot Theory}{q-Deformed Rationals and Knot Theory}}
