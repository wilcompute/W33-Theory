...
\section{\texorpdfstring{Bott Periodicity: The Period is $2^q$}{Bott Periodicity: The Period is 2^q}}
\label{sec:bott}
...
\section{\texorpdfstring{The Modular Functor: SU(2)${}_q$ Chern--Simons}{The Modular Functor: SU(2)_q Chern-Simons}}
