...
_sage_const_78 = Integer(78); _sage_const_40 = Integer(40); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_12 = Integer(12); _sage_const_24 = Integer(24); _sage_const_15 = Integer(15); _sage_const_51840 = Integer(51840); _sage_const_8 = Integer(8); _sage_const_0p1 = RealNumber('0.1'); _sage_const_240 = Integer(240); _sage_const_6 = Integer(6); _sage_const_72 = Integer(72)
...
try:
    ...
    def symplectic_form(x, y):
        ...
        return x[_sage_const_0 ]*y[_sage_const_1 ] - x[_sage_const_1 ]*y[_sage_const_0 ] + x[_sage_const_2 ]*y[_sage_const_3 ] - x[_sage_const_3 ]*y[_sage_const_2 ]
    ...
    for i in range(n):
        for j in range(i+_sage_const_1 , n):
            common = sum(_sage_const_1  for k in range(n) if adj_matrix[i,k] == _sage_const_1  and adj_matrix[j,k] == _sage_const_1 )
...
try:
    ...
    if _sage_const_12  in eig_counts and _sage_const_2  in eig_counts and -_sage_const_4  in eig_counts:
        if eig_counts[_sage_const_12 ] == _sage_const_1  and eig_counts[_sage_const_2 ] == _sage_const_24  and eig_counts[-_sage_const_4 ] == _sage_const_15 :
            print()
...
try:
    ...
    for signs in product([-_sage_const_1 , _sage_const_1 ], repeat=_sage_const_8 ):
        if sum(_sage_const_1  for s in signs if s < _sage_const_0 ) % _sage_const_2  == _sage_const_0 :
...
try:
    ...
    for eigenvalue, eigenvectors, multiplicity in eigendata:
        if abs(eigenvalue - _sage_const_2 ) < _sage_const_0p1 :  # eigenvalue 2
            ...
            print(f"Eigenvalue 2 eigenvectors: {len(eig2_vecs)} vectors of length {len(eig2_vecs[_sage_const_0 ]) if eig2_vecs else _sage_const_0 }")
