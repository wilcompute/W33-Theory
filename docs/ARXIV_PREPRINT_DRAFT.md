...
> **Post-March 2026 addendum.** The later cyclotomic tower now contributes seven additional exact layers beyond the original draft: (i) an adelic reciprocity theorem for the completed split-prime defect packet in the local variables $z_p=p^{-s}$; (ii) a closed-form global artanh expansion for the completed logarithm; (iii) an Eisenstein local-global valuation theorem identifying the Hensel branches with the valuations of $q\mp\omega$ by the split prime ideals in $\mathbb{Z}[\omega]$; (iv) a completed spectral $L$-family whose $\lambda=1$ slice is the completed defect Dirichlet package; (v) an odd Taylor-tower theorem showing that all even deformation coefficients vanish and that the family is uniformly analytic for $|\lambda|<6$ on the positive real $s$-axis; (vi) an infinite-cutoff theorem proving that this odd Taylor tower converges to a genuine limiting analytic object by absolute convergence and the Weierstrass $M$-test; and (vii) a completed spectral action / free-energy package in which the deformation cumulants and Hessian are explicit split-prime sums. In the current repository these are the MCII, MCIII, MCIV, MCV, MCVI, MCVII, and MCVIII theorem layers.
> **Post-March 2026 addendum.** The later cyclotomic tower now contributes eight additional exact layers beyond the original draft: (i) an adelic reciprocity theorem for the completed split-prime defect packet in the local variables $z_p=p^{-s}$; (ii) a closed-form global artanh expansion for the completed logarithm; (iii) an Eisenstein local-global valuation theorem identifying the Hensel branches with the valuations of $q\mp\omega$ by the split prime ideals in $\mathbb{Z}[\omega]$; (iv) a completed spectral $L$-package placing the defect product on a larger odd deformation family; (v) an odd Taylor theorem showing that all even deformation coefficients vanish and that the family is uniformly analytic for $|\lambda|<6$ on the positive real $s$-axis; (vi) an infinite-cutoff theorem proving that this odd Taylor tower converges to a genuine limiting analytic object by absolute convergence and the Weierstrass $M$-test; and (vii) a completed spectral action / free-energy package in which the deformation cumulants and Hessian are explicit split-prime sums; and (viii) a standalone infinite-cutoff spectral $L$-limit theorem showing that the full Euler product exists as a genuine global analytic object with certified cutoff error bounds. In the current repository these are the MCII, MCIII, MCIV, MCV, MCVI, MCVII, MCVIII, and MCIX theorem layers.
