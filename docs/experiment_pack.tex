...
\item
  ...
  inequality.
\item
  \textbf{\(Z_{3}\) geometric phase} via Pancharatnam triangle loops.
\end{enumerate}
...
\subsection{\texorpdfstring{4. \(Z_{3}\) Pancharatnam Phase
Test}{4. Z\_\{3\} Pancharatnam Phase Test}}\label{z_3-pancharatnam-phase-test}

\textbf{Key signature:} phase quantization in \{0,
...
\item
  Measure Pancharatnam triangles and verify \(Z_{3}\) phase clustering.
\end{enumerate}
...
\item
  \textbf{\(Z_{3}\) phase:} Φ \ensuremath{\in} \{0,
  \ensuremath{\pm}2\ensuremath{\pi}/3\} with robust clustering.
\end{itemize}
