...
through its own substrate-fixed drive --- no copies, no external apparatus.
\emph{(Honest scope: the quasicrystal structure --- three-gap, incommensurate
frequencies, non-recurrence --- is proven here; the topological protection is the
Fibonacci-drive analogy, not yet a prethermal-lifetime proof for the
$\arccos(-2/3)$ drive on the qutrit.)} (Witness:
