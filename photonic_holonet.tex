...
junctions already generate the full $\mathrm{Sp}(4,3)$ --- so ``runs on any
classical machine'' means any wiring that hosts four braid junctions, with the
hardware graph fixing only the embedding.
