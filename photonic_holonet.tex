...
one. The switches are two elementary braids of the carrier's worldline, robust
because braiding depends only on the topology --- the holonomic robustness again.
