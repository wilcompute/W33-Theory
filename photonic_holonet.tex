...
$\langle\chi_{H_1},\chi_{H_1}\rangle=1$: $H_1\otimes\mathbb{C}$ is
...
sentinel/clock layers are exactly the symmetry monitors.
\emph{Witness: \texttt{bt861\_code\_register\_is\_steinberg.py}.}
\end{theorem}
