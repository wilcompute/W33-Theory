...
\[
 1-81+(5+5+30)=-40=-v.
\]
The $5+\bar5$ outer-fusion pattern matches BT859's two chiral cache
branches, and the two 30-extensions have the form required for an
outer gauge bit, but the objectwise intertwiners to BT859 and BT857
remain open.
\emph{Witness:
\texttt{bt866\_h2\_oriented\_irreducible\_decomposition.py}.}
\end{corollary}
...
30-channel with an outer parity choice.  The watchdog is the BC loop.
