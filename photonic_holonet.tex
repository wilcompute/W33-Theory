...
\emph{Witnesses: \texttt{bt843\_icosahedral\_compass.py},
\texttt{bt844\_double\_five\_and\_six\_petersens.py},
\texttt{bt845\_pentad\_exchange\_and\_chart\_double\_cover.py}.}
\end{theorem}
...
element.
\emph{Further witnesses: \texttt{bt853\_dark\_orbit\_zoo.py},
\texttt{bt854\_dark\_chart\_transversal\_duality.py}.}
\emph{Witnesses: \texttt{bt848\_universal\_amalgam\_ladder.py},
\texttt{.tmp/gap\_bt848*.g}; cf.\ Hartley's classification ($17$
...
\emph{Witnesses: \texttt{bt849\_maniplex\_barren\_rung.py},
\texttt{bt850\_tomotope\_two\_orbit\_class.py},
\texttt{bt851\_tomotope\_cayley\_test.py},
\texttt{bt852\_seventeen\_universals.py},
\texttt{.tmp/gap\_bt849*.g}, \texttt{.tmp/gap\_bt852*.g}.}
...
Reye incidences.
\emph{Witnesses: \texttt{bt840\_clifford\_rook\_sentinel\_sheet.py},
\texttt{bt841\_eleven\_cell\_a5\_boundary\_carrier.py},
\texttt{bt842\_tomotope\_24cell\_half\_flag\_edge\_lift.py}.}
\end{theorem}
...
dark orbit zoo / shadow bijection / triple-stored timetable & bt853, bt854\\
universality & bt825\\
