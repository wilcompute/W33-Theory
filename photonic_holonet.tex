...
$\dim E_8=248=240+8$). But not everything reduces: the Monster minimal dimension
$196883=47\!\cdot\!59\!\cdot\!71$ and the fine-structure constant
($1/\alpha\approx137$) are \emph{not} Witting degrees or cyclotomic values. They sit
one level up, at the $c=24=f$ moonshine ceiling, reachable only through the
Monster/complex Leech ($196883=196560+\mu q^4-1$, with $196560$ the Leech kissing
number). So the unification is layered --- the Witting object directly fixes the
seven faces' structural integers, while $\alpha$ and the Monster require the full
moonshine ceiling welded at $c=24=f$. The fine-structure constant is the honest edge
the direct Eisenstein object does not fix. (Witness:
