...
register (the $[[240,81,3]]_3$ Steinberg module of \S\ref{sec:memory}, equivalently
$[[240,81,4,3]]_3$ in the explicitly ordered convention $[[n,k,d_Z,d_X]]_3$) that protects
...
holographic code (it stores the $81$ logical qutrits of the Steinberg module against
the combinatorial screening multiplicity $\mu=4$, while its CSS distances are
$d_X=3$, $d_Z=4$, and $d=3$), the magic fuel (its $36=(q!)^2$
...
kept alive by an irrational clock --- all controlled by $q=3$ ($\mu=4$,
$d_X=3$, $d_Z=4$,
...
graph cut, with a single ray's RT area the degree $k=12$, the proposed one-bulk-qutrit
RT cut having size $\mu=4$, equal to the one-sided $Z$-distance rather than the full
distance $d=3$, the gauge$\,|\,$matter cut $108=\mu\cdot27$, and an
