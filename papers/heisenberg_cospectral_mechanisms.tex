...
\begin{proposition}[integral data on the retained six pairs]\label{prop:smith}
For each of the six genuine pairs retained in Pass~480, the two members have
the same critical group. The five sheet-exchange pairs have $5$-primary part
$(\ZZ/125)^{23}\oplus(\ZZ/25)^{5}\oplus(\ZZ/5)^{16}$, while the one retained
sheet-coincidence pair has
$(\ZZ/125)^{23}\oplus(\ZZ/25)^{15}\oplus(\ZZ/5)^{6}$.
\end{proposition}

This proposition concerns six retained pairs, not all $66$ pairs in the census.
Moreover Pass~540 gives a further sheet-coincidence pair with the first of
these two Smith shapes. Thus Smith torsion fails to separate the graphs
\emph{within} these pairs and does not classify the mechanism. Weisfeiler--
Leman refinement separates the original displayed graphs within a pair (rank
$19$ versus $18$ at the first $2$-dimensional refinement); the content is the
two spectral mechanisms, not a Smith dichotomy.
