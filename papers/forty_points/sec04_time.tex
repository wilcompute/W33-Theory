...
fourth tick is a sign flip and whose eighth tick is the identity behaves exactly like a
spinor under rotation, and this is literal: the tick lifts to an element of order eight in
$GL(2,3)$ whose fourth power is the central $2\pi$ spin sign, and in Section~8 the same sign
is matter parity (Theorem~8.3).
