...
two further orbifold families built on the same twist, $\Z_2\times\Z_6$ ($29$ Standard Models) and
$\Z_3\times\Z_6$ ($5$), have no surviving parity either. The apparent opening was an artefact of an
