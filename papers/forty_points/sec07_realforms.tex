...
second. The black-hole quartic of Section~6 is the entropy formula in both.

More precisely, the clock's chain $E_{6(-26)}\subset E_{7(-25)}\subset E_{8(-24)}$ (all three
computed here, the first in Section~8) is exactly the chain of duality groups of the
octonionic magic $\mathcal N=2$ supergravity of G\"unaydin, Sierra and Townsend in five, four
and three space-time dimensions \cite{GST1983}: $E_{6(-26)}$ acts on the $27$ charges in five
dimensions, $E_{7(-25)}$ on the $56$ in four, and $E_{8(-24)}$ is the symmetry of the
three-dimensional theory obtained by one more reduction. The split chain plays the same role
for maximal supergravity. \tierB
\end{physical}
