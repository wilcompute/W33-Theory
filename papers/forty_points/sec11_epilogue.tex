...
\item \textbf{Chirality from outside.} Theorem~9.5 proves that handedness cannot be selected
      from inside, and the swap is antiunitary. Is the external datum that fixes it the same as
      the one that fixes the arrow of time (Section~4.10) --- the choice of the unitary,
      completely positive half of the symmetry group?
