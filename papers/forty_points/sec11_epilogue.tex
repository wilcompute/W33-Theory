...
\item \textbf{A realistic vacuum.} Every parity built from the gauge torus and the space group
      is excluded (Theorem~9.6 and its extensions), in $\Z_6$ and in $\Z_{12}$-I alike. The one
      surviving door is a parity made of plane rotations in $\Z_6$II$_{23}$. There the problem has been
      reduced to a single sharp question: is there a vacuum in which the rotation symmetry is broken
      at low order for the exotic triplets but only at very high order for one Higgs pair (an
      \emph{approximate} $R$-symmetry), and are its own $F$-equations solvable? Beyond that lie the
      orbifolds not yet scanned, above all $\Z_2\times\Z_2$, where an anomaly-free $\Z_4^R$ is known
      to be realisable.
...
directions each compatible with a parity form a parity-even vacuum & they must be even under \emph{one} element; the 84-direction vacuum was withdrawn, a 68-direction one certified (\S9.4)\\
the Higgs quartic is positive at unification ($+1/40$) & measured running gives $-0.011$ at $10^{16}$\,GeV (\S9.4)\\
\bottomrule
\end{tabularx}
\end{center}
