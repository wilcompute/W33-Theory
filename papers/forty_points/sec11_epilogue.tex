...
\begin{tikzpicture}[
  ...
  \node[it] at (7.9,-0.75) {$\bullet$ a dynamical principle\\
     ...
     $\bullet$ a realistic SUSY vacuum\\
...
\item \textbf{A realistic vacuum.} Find, or exclude, an $F$- and $D$-flat vacuum of the
      $\Z_6$-I $\W$ class that condenses only matter-even singlets. It is a finite
      computation over explicit charge matrices and superpotential terms.
...
\item \textbf{A continuum limit.} The finite light cones (in $2+1$, $3+1$, $1+9$ and the
      ...
      dynamical curvature?
\item \textbf{Chirality from outside.} Theorem~9.5 proves that handedness cannot be selected
      from inside. What minimal external datum --- an orientation of the history cycle, a Weil
      phase, a vacuum --- selects it, and is it the \emph{same} datum in each case?
