...
state. The BT110--BT113 WRF harnesses \cite{wrf-bt110-bt111,wrf-bt112,wrf-bt113} test the first
...
noise model, a physical write-injection circuit, a physical coupling layer for interacting
...
T_{\rm write}^{\rm ctrl}&\leq 3,&
T_{\rm repair}^{\rm ctrl}&\leq 3,\\
...
return path whose control word is itself receipt-bearing.
