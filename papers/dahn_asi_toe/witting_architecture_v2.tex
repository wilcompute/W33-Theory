...
state. The BT110--BT112 WRF harnesses \cite{wrf-bt110-bt111,wrf-bt112} test the first
...
basin in the tested harness. This is trajectory stability, not a physical noise model.\\
Register isolation &
...
$18$, corresponding to a $t=9$ symbolic correction budget in that sample.\\
Spectral audit &
...
noise model, a physical write-injection circuit, a coupling algebra for interacting
cells, and capacity accounting under real read windows. The paper therefore uses
...
\[
T_{\rm lock}\leq 37\ \text{steps in the four-seed harness},\qquad
d_{\rm CID}^{\rm sample}=18,\qquad
