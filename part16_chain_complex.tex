...
% ═══════════════════════════════════════════════════════════════
\clearpage
\part{\texorpdfstring{The Chain Complex: From E${}_6$ Geometry to Supersymmetry}{The Chain Complex: From E6 Geometry to Supersymmetry}}

\section{\texorpdfstring{$\mathrm{Aut}(\mathrm{W}(3,3)) = W(E_6)$}{Aut(W(3,3)) = W(E6)}}
...
\section{\texorpdfstring{The $27$ Spreads and the Cubic Surface}{The 27 Spreads and the Cubic Surface}}
...
\section{\texorpdfstring{The $\mathfrak{so}(k)$ Decomposition}{The so(k) Decomposition}}
...
\section{\texorpdfstring{$\alpha^{-1}$ from the Euler Characteristic}{alpha-inverse from the Euler Characteristic}}
