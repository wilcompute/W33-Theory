...
print(f"  Error: {abs(sin_cabibbo_w33 - math.sin(theta_12_CKM))/math.sin(theta_12_CKM)*100:.2f}%")
print()
...
print("═══ Verification ═══")
print()
print(f"  sin²θ_12(PMNS) / sin²θ_12(CKM) = {0.303}/{(9/40)**2:.4f} = {0.303/((9/40)**2):.1f}")
