...
%-----------------------------------------------------------------------
\section{\texorpdfstring{The Ihara Zeta Function of $W(3,3)$}{The Ihara Zeta Function of W(3,3)}}
\label{sec:ihara}
...
%-----------------------------------------------------------------------
\section{\texorpdfstring{The Ramanujan Bound over $\mathbb{Q}(\varphi)$}{The Ramanujan Bound over Q(phi)}}
\label{sec:ramanujan}
...
%-----------------------------------------------------------------------
\section{\texorpdfstring{The $H_4$ Golden Forcing Argument}{The H4 Golden Forcing Argument}}
