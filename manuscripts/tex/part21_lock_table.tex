...
\begin{longtable}{@{}>{\raggedleft\arraybackslash}p{0.06\linewidth}@{\hspace{0.4em}}>{\raggedright\arraybackslash}p{0.16\linewidth}@{\hspace{0.4em}}>{\raggedright\arraybackslash}p{0.51\linewidth}@{\hspace{0.4em}}>{\raggedright\arraybackslash}p{0.13\linewidth}@{}}
\hline
...
13 & Jungerman--Ringel obstruction &
  ...
  embedding in the Jungerman--Ringel theorem~\cite{JR1980_part21}; its resolution by
...
\begin{enumerate}
  ...
  \item \textbf{ATLAS uniqueness}: $\mathrm{PSp}(4,3)$ has a unique complex irrep
    of dimension~$15$~\cite{ATLAS_part21}, and that irrep is the adjoint of
