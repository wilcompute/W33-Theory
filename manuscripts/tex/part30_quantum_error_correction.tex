...
%-----------------------------------------------------------------------
\section{\texorpdfstring{The Golay Code from $W(3,3)$}{The Golay Code from W(3,3)}}
\label{sec:golay}
...
%-----------------------------------------------------------------------
\section{\texorpdfstring{The $W(3,3)$ Stabiliser Code $\mathcal{Q}_W$}{The W(3,3) Stabiliser Code QW}}
...
%-----------------------------------------------------------------------
\section{\texorpdfstring{Fault Tolerance and the $\mu=4$ Threshold}{Fault Tolerance and the mu=4 Threshold}}
