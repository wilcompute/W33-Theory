...
\section{\texorpdfstring{The $q$-Pascal Triangle: Quantum Group Structure}{The q-Pascal Triangle: Quantum Group Structure}}
...
\section{\texorpdfstring{The 600-Cell: Hyperbolic Pascal Meets E${}_8$}{The 600-Cell: Hyperbolic Pascal Meets E8}}
\label{sec:600cell}
...
\section{\texorpdfstring{The $q$-Clifford Algebra: Quantization of Gauge Structure}{The q-Clifford Algebra: Quantization of Gauge Structure}}
\label{sec:qclifford}
...
\section{\texorpdfstring{The Multinomial Pascal $d$-Simplex}{The Multinomial Pascal d-Simplex}}
