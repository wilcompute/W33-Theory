...
$51{,}840 = |\mathrm{Sp}(4,3)|$ is attained by \textbf{two} of the $28$, not one. So the
zeta distinguishes $1$ class of $28$, $|\mathrm{Aut}|$ distinguishes $20$, and separating
the final pair needs something neither provides. That residual ambiguity is an open
question, recorded as one rather than rounded away.
\end{spec}
