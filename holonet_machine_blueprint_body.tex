...
polynomial of that pencil --- with \textbf{no closed form of degree ten or less}.
Irregularity does not merely break the $k$-regular formula. It removes the closed form.
\end{spec}
...
re-check the residual at double precision --- it must fall, not plateau.}
\end{plain}
