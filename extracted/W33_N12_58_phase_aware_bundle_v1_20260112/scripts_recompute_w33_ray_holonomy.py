...
def main():
    ...
    pd.DataFrame(rows).to_csv(f"{args.outdir}/w33_noncollinear_edge_phases_k_mod12.csv", index=False)
    ...
    df.to_csv(f"{args.outdir}/w33_four_center_triads_with_ray_holonomy.csv", index=False)
