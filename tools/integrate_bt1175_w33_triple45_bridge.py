...
INSERT = ROOT / "analysis" / "BT1175_w33_paper_triple45_bridge_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{thm:triple-fortyfive-incidence-bridge}"
PREREQ = "\\label{thm:boolean-tritangent-incidence45}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1172 missing")
