#!/usr/bin/env python3
"""Idempotently materialize the Passes 4777--4784 theorem card into docs/index.html."""
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]
INDEX=ROOT/'docs/index.html'
CARD=ROOT/'analysis/PASS4777_4784_matrix_blt_d4_triangle_router_index_insert.html'
TOKEN='id="pass4777-4784-matrix-blt-d4-triangle-router"'
def main():
    text=INDEX.read_text(encoding='utf-8');n=text.count(TOKEN)
    if n>1:raise RuntimeError('duplicate Pass4777-4784 card')
    if n==0:
