...
INSERT = ROOT / "analysis" / "BT1160_w33_paper_boolean_bridge_obstruction_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{rem:boolean-bridge-obstruction}"
PREREQ = "\\label{rem:signature-clifford-refinement}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1157 missing")
