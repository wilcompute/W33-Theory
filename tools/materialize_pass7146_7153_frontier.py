#!/usr/bin/env python3
"""Idempotently materialize the Pass7146-7153 public frontier card."""
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]
TARGETS=(ROOT/'docs'/'index.html',ROOT/'index.html')
TOKEN='pass-7146-7153-q9-pgl2-hexad-code'
CARD=(ROOT/'analysis'/'PASS7146_7153_index_insert.html').read_text(encoding='utf-8').rstrip()+'\n'
...
def place(path:Path)->str:
    ...
    out=text[:pos]+CARD+text[pos:]; assert out.count(marker)==1
