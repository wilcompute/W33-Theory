#!/usr/bin/env python3
"""Idempotently materialize the Pass7171-7186 public frontier card."""
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1]
TARGETS=(ROOT/'docs'/'index.html',ROOT/'index.html')
TOKEN='pass-7171-7186-e8-d4-q9'
CARD=(ROOT/'analysis'/'PASS7171_7186_index_insert.html').read_text(encoding='utf-8').rstrip()+'\n'
def place(path:Path)->str:
    ...
    out=text[:pos]+CARD+text[pos:];assert out.count(marker)==1;path.write_text(out,encoding='utf-8');return 'inserted'
def main():
