...
INSERT = ROOT / "analysis" / "BT1157_w33_paper_signature_clifford_refinement_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{rem:signature-clifford-refinement}"
PREREQ = "\\label{thm:projective-fifteen-refinement}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1154 missing")
