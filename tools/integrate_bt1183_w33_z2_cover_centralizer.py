...
INSERT = ROOT / "analysis" / "BT1183_w33_paper_z2_cover_centralizer_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{rem:z2-cover-centralizer96}"
PREREQ = "\\label{rem:triple-fortyfive-z2-obstruction}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1179 missing")
