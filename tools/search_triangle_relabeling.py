...
We keep the Schläfli line set fixed but allow a permutation of the 27 lines
that preserves the Schläfli intersection graph. This is a graph automorphism.
...
known symmetries of the Schläfli graph (via S6 action on indices and
E<->C swap), not full Aut(Schläfli)=W(E6).
"""
