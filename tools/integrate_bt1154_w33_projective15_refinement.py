...
INSERT = ROOT / "analysis" / "BT1154_w33_paper_projective_15_refinement_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{thm:projective-fifteen-refinement}"
PREREQ = "\\label{rem:projective-fifteen-sector}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1151 missing")
