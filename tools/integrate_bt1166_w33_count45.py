...
INSERT = ROOT / "analysis" / "BT1166_w33_paper_45split_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{thm:boolean-fortyfive-split}"
PREREQ = "\\label{thm:projected-boolean-quotient-module}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1163 missing")
