...
_sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_8 = Integer(8); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2)
...
def graph_summary(G):
    ...
    try:
        ...
        counts = Counter(eigs)
        spectrum = sorted([(int(e), int(m)) for e, m in counts.items()], key=lambda x: -x[_sage_const_0 ])
    except Exception:
        spectrum = None
    return {
        "order": G.order(),
