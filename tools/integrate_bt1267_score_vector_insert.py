...
SRC = ROOT / "analysis" / "BT1267_score_vector_paper_section.tex"
DST = ROOT / "paper" / "sections" / "sec_bt1267_tomography_score_vector.tex"
PRE = ROOT / "paper" / "w33_preprint.tex"
INPUT = r"\input{sections/sec_bt1267_tomography_score_vector}"
ANCHORS = [
