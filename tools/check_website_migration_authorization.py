...
def validate_website_index(repository_root: Path, *, expected_blob: str = RESTORED_INDEX_BLOB, authorization_path: Path = DEFAULT_AUTHORIZATION_PATH) -> dict[str, Any]:
    ...
    if actual_blob == expected_blob:
        return {"status": "PASS_RESTORED_INDEX_UNCHANGED", "actual_blob": actual_blob, "expected_blob": expected_blob, "authorization_used": False}
...
def main() -> None:
    ...
    try:
        result = validate_website_index(args.repository_root, expected_blob=args.expected_blob, authorization_path=args.authorization)
