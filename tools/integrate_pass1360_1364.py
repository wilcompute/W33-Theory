#!/usr/bin/env python3
"""Idempotently integrate the Pass 1360--1364 theorem into both manuscripts."""
...
INPUT = r"\input{analysis/BT1360_BT1364_gelfand_terwilliger}"
...
def main():
    ...
    if args.check:
        ...
        print("PASS 1364: dual-manuscript integration present exactly once")
        return

    changed = [path.name for path in TARGETS if integrate(path)]
    print("PASS 1364: integrated " + (", ".join(changed) if changed else "already current"))
