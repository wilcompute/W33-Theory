...
REQUIRED='analysis/BT3989_BT3996_physical_incidence_photon_breakthrough_insert'
...
def main():
    ...
    print('PASS_3989_3996_FRONTIER_RECONCILE',required.count(REQUIRED),sum(x.get('token')==PUBLIC['token'] for x in sections),sum(x.get('token')==PAGE['token'] for x in pages))
