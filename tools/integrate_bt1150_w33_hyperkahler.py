...
INSERT = ROOT / "analysis" / "BT1150_w33_paper_hyperkahler_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{rem:k3-hyperkahler-weyl-chirality}"
PREREQ = "\\label{rem:k3-global-orientation}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1149 missing")
