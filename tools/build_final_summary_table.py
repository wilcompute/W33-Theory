...
# Tier definitions
entries: list[Entry] = [
    Entry("Tier 1", "alpha^-1", "81 + 56 + 40/(1080+31+1/7)", alpha_inv, 137.035999084, None),
...
lines.append("")
lines.append("Generated by `tools/build_final_summary_table.py` using the formulas and comparison values embedded in FINAL_THEORY_SUMMARY.md (Jan 25, 2026).")
lines.append("")
