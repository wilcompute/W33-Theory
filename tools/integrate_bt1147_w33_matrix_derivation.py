...
INSERT = ROOT / "analysis" / "BT1147_w33_paper_matrix_derivation_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{rem:k3-a4-matrix-check}"
PREREQ = "\\label{thm:k3-w33-metric-bridge}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1145 missing")
