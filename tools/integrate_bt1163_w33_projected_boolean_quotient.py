...
INSERT = ROOT / "analysis" / "BT1163_w33_paper_quotient_boolean_module_insert.tex"
MARKER = "\\begin{theorem}[The complete spectral action of $W(3,3)$]"
SENTINEL = "\\label{thm:projected-boolean-quotient-module}"
PREREQ = "\\label{rem:boolean-bridge-obstruction}"
...
def main():
    ...
    if PREREQ not in text:
        raise RuntimeError("BT1160 missing")
