#!/usr/bin/env python3
"""Idempotently integrate BT659 into the W33 preprint."""
from __future__ import annotations
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
SRC = ROOT / "analysis" / "BT659_s4_trace_codec_split_insert.tex"
DST = ROOT / "paper" / "sections" / "sec_bt659_s4_trace_codec_split.tex"
PREPRINT = ROOT / "paper" / "w33_preprint.tex"
INPUT = r"\input{sections/sec_bt659_s4_trace_codec_split}"
MARKERS = [
