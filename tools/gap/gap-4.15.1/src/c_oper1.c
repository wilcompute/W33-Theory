 ...
 Obj  a_mutflag )
{
 ...
 if ( t_1 ) {
  ...
  if ( t_1 ) {
   ...
   t_7 = NewFunctionBody();
   SET_STARTLINE_BODY(t_7, 767);
   SET_ENDLINE_BODY(t_7, 785);
 ...
 Obj  a_keytest )
{
 ...
 if ( t_1 ) {
  ...
  t_2 = NewFunctionBody();
  SET_STARTLINE_BODY(t_2, 964);
  SET_ENDLINE_BODY(t_2, 968);
 ...
 SET_ENVI_FUNC( t_6, STATE(CurrLVars) );
 t_7 = NewFunctionBody();
 SET_STARTLINE_BODY(t_7, 985);
 SET_ENDLINE_BODY(t_7, 985);
 SET_FILENAME_BODY(t_7, FileName);
 SET_BODY_FUNC(t_6, t_7);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
 ...
 SET_ENVI_FUNC( t_6, STATE(CurrLVars) );
 t_7 = NewFunctionBody();
 SET_STARTLINE_BODY(t_7, 1007);
 SET_ENDLINE_BODY(t_7, 1030);
 SET_FILENAME_BODY(t_7, FileName);
 SET_BODY_FUNC(t_6, t_7);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_6ARGS( t_1, t_2, t_3, t_4, t_5, INTOBJ_INT(0), t_6 );
 ...
 SET_ENVI_FUNC( t_6, STATE(CurrLVars) );
 t_7 = NewFunctionBody();
 SET_STARTLINE_BODY(t_7, 1040);
 SET_ENDLINE_BODY(t_7, 1048);
 SET_FILENAME_BODY(t_7, FileName);
 SET_BODY_FUNC(t_6, t_7);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_6ARGS( t_1, t_2, t_3, t_4, t_5, INTOBJ_INT(0), t_6 );
 ...
 SET_ENVI_FUNC( t_6, STATE(CurrLVars) );
 t_7 = NewFunctionBody();
 SET_STARTLINE_BODY(t_7, 1057);
 SET_ENDLINE_BODY(t_7, 1070);
 SET_FILENAME_BODY(t_7, FileName);
 SET_BODY_FUNC(t_6, t_7);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_6ARGS( t_1, t_2, t_3, t_4, t_5, INTOBJ_INT(0), t_6 );
 ...
 Obj  a_arg )
{
 ...
 t_5 = NewFunctionBody();
 SET_STARTLINE_BODY(t_5, 1136);
 SET_ENDLINE_BODY(t_5, 1152);
 ...
 Obj  self )
{
 ...
 /* BIND_GLOBAL( "INSTALL_METHOD", function ( arglist, check )
      local len, opr, info, pos, rel, filters, info1, isstr, flags, i, rank, method, oreqs, req, reqs, match, j, k, imp, notmatch, lk, funcname, alt_rank;
      ;
      len := LEN_LIST( arglist );
      if len < 3 then
          Error( "too few arguments given in <arglist>" );
 ...
 t_3 = NewFunctionBody();
 SET_STARTLINE_BODY(t_3, 725);
 SET_ENDLINE_BODY(t_3, 789);
 ...
 SET_ENVI_FUNC( t_2, STATE(CurrLVars) );
 t_3 = NewFunctionBody();
 SET_STARTLINE_BODY(t_3, 792);
 SET_ENDLINE_BODY(t_3, 798);
 SET_FILENAME_BODY(t_3, FileName);
 SET_BODY_FUNC(t_2, t_3);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_1ARGS( t_1, t_2 );
 ...
 SET_ENVI_FUNC( t_3, STATE(CurrLVars) );
 t_4 = NewFunctionBody();
 SET_STARTLINE_BODY(t_4, 811);
 SET_ENDLINE_BODY(t_4, 835);
 SET_FILENAME_BODY(t_4, FileName);
 SET_BODY_FUNC(t_3, t_4);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_2ARGS( t_1, t_2, t_3 );
 ...
 SET_ENVI_FUNC( t_3, STATE(CurrLVars) );
 t_4 = NewFunctionBody();
 SET_STARTLINE_BODY(t_4, 960);
 SET_ENDLINE_BODY(t_4, 1071);
 SET_FILENAME_BODY(t_4, FileName);
 SET_BODY_FUNC(t_3, t_4);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_2ARGS( t_1, t_2, t_3 );
 ...
 SET_ENVI_FUNC( t_3, STATE(CurrLVars) );
 t_4 = NewFunctionBody();
 SET_STARTLINE_BODY(t_4, 1106);
 SET_ENDLINE_BODY(t_4, 1153);
 SET_FILENAME_BODY(t_4, FileName);
 SET_BODY_FUNC(t_3, t_4);
 if ( TNUM_OBJ( t_1 ) == T_FUNCTION ) {
  CALL_2ARGS( t_1, t_2, t_3 );
 ...
 SET_ENVI_FUNC( t_1, STATE(CurrLVars) );
 t_2 = NewFunctionBody();
 SET_STARTLINE_BODY(t_2, 1169);
 SET_ENDLINE_BODY(t_2, 1169);
 SET_FILENAME_BODY(t_2, FileName);
 SET_BODY_FUNC(t_1, t_2);
...
static Int PostRestore ( StructInitInfo * module )
{
 ...
 G_RANK__SHIFT__FUNCTION = GVarName( "RANK_SHIFT_FUNCTION" );
...
static Int InitKernel ( StructInitInfo * module )
{
 ...
 InitFopyGVar( "RANK_SHIFT_FUNCTION", &GF_RANK__SHIFT__FUNCTION );
