#!/usr/bin/env python3
"""Idempotently materialize the Pass7138-7145 public frontier card."""
from pathlib import Path

ROOT=Path(__file__).resolve().parents[1]
TARGETS=(ROOT/'docs'/'index.html',ROOT/'index.html')
TOKEN='pass-7138-7145-c2-normalform-matrix-quotient'
CARD=(ROOT/'analysis'/'PASS7138_7145_index_insert.html').read_text(encoding='utf-8').rstrip()+'\n'
