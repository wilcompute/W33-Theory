...
SRC = ROOT / "analysis" / "BT1276_external_candidate_protocol_paper_section.tex"
DST = ROOT / "paper" / "sections" / "sec_bt1276_external_candidate_protocol.tex"
PRE = ROOT / "paper" / "w33_preprint.tex"
INPUT = r"\input{sections/sec_bt1276_external_candidate_protocol}"
ANCHORS = [
