...
\begin{theorem}[Three-term substrate expansion of $\alpha^{-1}$; MCCLXXI]\label{thm:alpha_three_term}
The Sommerfeld constant satisfies
\[
  \alpha^{-1} \;=\; \underbrace{(2^{\Phi_6} + q^2)}_{137}
                  + \underbrace{\frac{1}{\mu\,\Phi_6}}_{1/28}
                  + \underbrace{\frac{1}{q^q\,\Phi_3\,\Phi_4 + 1}}_{1/3511}
                  + (<21~\mathrm{ppb~residue}).
\]
The third-correction denominator is the substrate-clean integer
\[
  3511 \;=\; q^q\,\Phi_3\,\Phi_4 + 1 \;=\; \mathrm{Heegner}_{43}\cdot\mathrm{Heegner}_{67}
                                          + q^2\,\Phi_4\,\Phi_6
\]
(both factorizations exact; $3511$ is prime).  Numerical value:
\[
  \alpha^{-1}_{\text{substrate}} = 137.0359991049, \qquad
  \alpha^{-1}_{\text{CODATA-2018}} = 137.0359990840,
\]
matching to $2.1\times 10^{-8}$ (21 ppb) with ZERO free parameters.
The third correction connects $\alpha$ to QCD chiral dynamics
($f_\pi = \Phi_3\Phi_4$) and the generation cube ($q^q$).  Solves
the open frontier identified in MCCLXVI--MCCLXX.
\end{theorem}
