...
\begin{equation}
  Y_{21} = \frac{q^2}{v} = \frac{9}{40},\quad
  Y_{22}^{\mathrm{trip}} = \frac{q}{v-q} = \frac{3}{37},\quad
  Y_{22}^{\mathrm{down}} = \frac{\mu+1}{2\Phisix(v-q)} = \frac{5}{518},\quad
...
In $W(3,3)$ language:
\begin{equation}
  \theta_0 = \frac{C_2(\mathbf{3})}{C_2(\mathrm{Sym}^3(\mathbf{3}))} = \frac{\mu/q}{2q} = \frac{\mu}{2q^2} = \frac{\lambda}{q^2} = \frac{2}{9},
\end{equation}
