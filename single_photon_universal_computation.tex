...
connects single-photon sources to MBQC via cluster states.  \Cref{sec:encoding}
presents the structural encoding theorem, and \cref{sec:conclusions} concludes.
...
\begin{itemize}[noitemsep]
  ...
  \item \textbf{Structural encoding theorem:} all 20 cardinal numbers of photonic
    universality are closed arithmetic expressions in the $W(3,3)$ parameter table.
\end{itemize}
