...
> **Zero free parameters.** Everything is substrate-fixed. BT1298 repaired the executable witness so this table is generated by the same formulas: `(q+1)(q^2+1)` for the W(3,3) point count and `4q+2` for Cayley diameter.
