# Passes 1971–1975 release

## Status

`PASS_WITH_CHI_AND_CANDIDATE_ORBIT_BOUNDARIES`

Frozen verification: **45/45** certificate checks.
...
- **1975:** published a 32-row claim-status ledger and separated exact physics from five computer-engineering proposals and four testable hypotheses.

## Boundaries

`chi(H)=9` remains open. The candidate-orbit property is not proved for every associated or arbitrary symplectic spread, and linewise-involution existence and uniqueness remain open beyond the stated scope. Charge, homological flux, QCD colour, generation, and neutrino readings remain withdrawn. Hardware proposals are not device demonstrations or fundamental-physics identifications.
