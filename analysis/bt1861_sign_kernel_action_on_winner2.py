...
Tests what can be said about the BT1860 central-inversion sign-kernel candidate
acting on the canonical winner-2 selector. Since the candidate reduces to
identity on the mod-2 chain shadow, it fixes the support-mask selector at H
level. What remains open is whether a chosen integral representative lift
changes signs/phases inside an integral E8 representative without changing the
support mask.
"""
...
CENTRAL_INVERSION_MOD2 = [[1, 0], [0, 1]]
...
def theorem_summary():
    ...
    checks = {
        ...
        "mod2_shadow_identity": CENTRAL_INVERSION_MOD2 == [[1, 0], [0, 1]],
    ...
    return {
        ...
        "sign_kernel_candidate": "four-plane A2 central inversion from BT1860/BT1865",
