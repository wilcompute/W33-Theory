...
out={'schema':'w33.pass1222.a2_normalizer_triality.v1','status':'PASS','base_a2_triple':list(c.base_data()['a2_triple']),
 ...
 'three_432_carriers':{'orbit_indices':[11,12,13],'S3_image_order':6,'action_permutations':color_actions,'point_stabilizer_order':2,'verdict':'transitive S3 triality action, not a free S3 torsor','orientation_preserving_C3_is_free_transitive':True},
