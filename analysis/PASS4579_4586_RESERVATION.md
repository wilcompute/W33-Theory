...
- Sequential manuscript attachment is intentionally deferred until the concurrently active Passes 4571--4578 insert exists, so pass history is not reordered or duplicated. The 4579--4586 insert itself is complete and ready to chain immediately after 4571--4578.
