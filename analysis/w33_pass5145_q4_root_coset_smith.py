#!/usr/bin/env python3
"""Pass5145: exact integral Smith form of the q=4 C2 root-coset incidence matrix."""
...
OUT=ROOT/'data/PART_W33_PASS5145_Q4_ROOT_COSET_SMITH.json'
...
def main():
    ...
    out={'pass':5145,'status':'THEOREM_Q4_ROOT_COSET_SMITH_FORM','q':4,'shape':[256,256],
         ...
         'comparison':{'q2':'torsion-free nonzero Smith shell 1^15','q3':'1^68 plus 3^1 from Pass5107/5115'},
         'boundary':'This is the q=4 integral incidence cokernel. No q=5 Smith form is claimed; the direct q=5 Smith computation remains substantially heavier.'}
