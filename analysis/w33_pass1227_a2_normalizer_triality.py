...
import w33_pass1223_1227_exact_core as c
...
out={'schema':'w33.pass1227.a2_normalizer_triality.v1','status':'PASS','base_a2_triple':list(c.base_data()['a2_triple']),
...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'data'/'w33_pass1227_a2_normalizer_triality.json'
OUT.parent.mkdir(parents=True,exist_ok=True);OUT.write_text(json.dumps(out,indent=2)+'\n')
print('PASS 1227 S3 triality / C3 torsor / six-shell S3 torsor')
