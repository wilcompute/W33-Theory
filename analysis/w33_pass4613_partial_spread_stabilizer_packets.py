#!/usr/bin/env python3
"""Pass 4613 bonkers -- canonical 135->45 stabilizer packets of maximal partial spreads."""
from __future__ import annotations
import json
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'data/PART_W33_PASS4613_PARTIAL_SPREAD_STABILIZER_PACKETS.json'
def main():
    d=json.loads((ROOT/'data/PART_W33_PASS4610_CONCRETE_D4_TRIALITY_W33_LIFTS.json').read_text())
    ...
    out={'pass':4613,'source_carrier':'the transitive 135 maximal/unextendable size-8 W33 partial spreads of Pass1100',
      'packet_definition':'three partial spreads with the same order-192 setwise stabilizer H exposed by the Pass4610 half-spinor lift',
