"""Passes 5416-5419 -- the action exists, it fixes a vertex, and the Lean layer has
nothing to say about any of it.

  5416  Pass 5343 established that 576 divides 13! and refused to call that an action.
  ...
  5417  And the action is NOT transitive.  Orbit sizes are [1, 12]: one dual grid among the
        thirteen is fixed by everything, and the other twelve form a single orbit.  The
        simplex has a distinguished vertex.

  5418  GAP's structure description of the image is ((A4 x A4) : C2) : C2, order 576,
  ...
  5419  The Lean library was checked for anything bearing on this.  It has nothing, and the
        reason is structural and stated in its own headers.

    py -3 analysis/w33_pass5416_5419_the_stabiliser_does_act_and_fixes_one_vertex.py
"""
...
def main() -> int:
    print("=" * 78)
    print("Passes 5416-5419 -- it acts, and it fixes one")
    print("=" * 78)
    ...
    print("\n  PASS 5416 -- the question three passes declined to answer\n")
    ...
    print("\n  PASS 5417 -- the simplex has a distinguished vertex\n")
    ...
    print("\n  PASS 5418 -- two descriptions of one order\n")
    ...
    print("\n  PASS 5419 -- the Lean library, checked and empty on this\n")
    ...
    out = {
        "boundary": ("Pass 5416-5417 are GAP computations over the P-block graph built from "
                     "the other lane's Pass5212 geometry(5); the SELECTED 13-cover is "
                     "theirs. Pass 5418 REPORTS a structural-description difference and "
                     "does not resolve it -- the orders agree and the ambient settings "
                     "differ. Pass 5419 is a scope check of formal/W33 only, by keyword"),
        "pass_5416": {"aut_order": stab["aut_order"],
        ...
        "pass_5417": {"orbit_sizes": orb["orbit_sizes"], "n_orbits": orb["n_orbits"],
        ...
        "pass_5418": {"image_structure": orb["structure"],
        ...
        "pass_5419": {"modules": len(mods), "relevant": hits,
    ...
    fp = ROOT / "data" / "PART_W33_PASS5416_5419_STABILISER_ACTS_AND_FIXES_ONE.json"
