...
def main():
    ...
    compact={'schema':'w33.pass1226.literal_cycle_orbits_7_8.v1','status':'PASS','headline':'Literal primitive tailless nonbacktracking cycle orbits are classified at lengths seven and eight.','encoding':'hex packs vertex_i in bits [6i,6i+5]','lengths':{}}
    ...
    ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'data'/'w33_pass1226_literal_cycle_orbits_7_8.json'
