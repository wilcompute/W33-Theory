...
assert a['nine_tritangent_exact_covers']==200
assert a['line_cover_incidences']==320
assert a['multiplicity_census']=={'one_line':160,'four_lines':40}
assert b['covers']==b['incident_point_line_pairs']==160 and b['bijection']
...
assert 320-240+1==81
assert (2**83)*(5**23)==115292150460684697600000000000000000000000
print('PASS Pass5016-5019 regression')
