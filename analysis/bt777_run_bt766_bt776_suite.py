#!/usr/bin/env python3
"""BT777 — import-based theorem-suite runner for BT766--BT776.

Runs the octet/projector/bus verifier modules in dependency order by importing
each module and calling its main() function directly.
"""
...
def main():
    ...
    summary = {
        "theorem": "BT777 BT766--BT776 Import-Based Theorem Suite",
        ...
        "boundary": "This runner checks the local Python theorem stack only. It does not validate external GAP, LaTeX, or unavailable root-torsor artifacts."
    }
