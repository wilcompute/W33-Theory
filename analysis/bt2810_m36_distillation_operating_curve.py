#!/usr/bin/env python3
"""Pass 2810: exact operating curve for the explicit deep M36 distillation branch."""
...
OUT = ROOT / "data" / "PART_BT2810_M36_DISTILLATION_OPERATING_CURVE_results.json"
...
def main() -> None:
    samples = [Fraction(1, 2), Fraction(1, 3), Fraction(1, 10)]
    checks = {
    ...
    payload = {
        "schema": "w33.pass2810.m36_distillation_operating_curve.v1",
        ...
        "rational_samples": [as_row(p) for p in samples],
