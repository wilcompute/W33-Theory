...
executable leakage simulator certifies only the falsifier thresholds
|delta V(F3)|<=0.05 and radial leakage<=0.10; Pass409 explicitly leaves
tritter process fidelity and insertion loss unspecified. M36 injection remains
refused because this compiler is Clifford-only.
"""
