...
[
n=3,i+a,qquad iin\{0,…,26\}, ain\mathbb F_3,
]
the source-locked root bracket is
[
[e_{i,a},e_{j,b}]=d_{ijk}epsilon_{abc},ar e_{k,c}.
]
...
After pairing the g2 labels with the same ((i,a)) labels, every tested (D_v)
...
classical Vinberg order-three E8 representation (SL_3	imes E_6) on
(3otimes27), but no generic-orbit or Cartan-subspace classification is
