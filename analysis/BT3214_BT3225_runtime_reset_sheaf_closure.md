...
important contextuality arguments.  Caru (arXiv:1701.00656) proves the obstruction is not a
...
through image rank rather than through a verbal synchronization analogy.  The exact information
loss for full belief reset is

\[
 \log_2 876 = 9.7747870596\ \text{bits}.
\]

At 300 K its Landauer floor is
...
This is a thermodynamic lower bound, not a CMOS or optical energy forecast.  The phase marker by
itself has zero epistemic-reset cost because it leaves all 876 belief states distinguishable.
