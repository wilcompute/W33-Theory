#!/usr/bin/env python3
"""Transparent compatibility validator for the rank-81 Steinberg bridge."""
...
REQUIRED = ("steinberg_transform", "enhanced_map")
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "schema": "w33.pass1143.intertwiner_compatibility.v1",
                "status": "PASS",
