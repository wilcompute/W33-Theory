...
def main() -> None:
    ...
    determinant_no_go = load("w33_pass1029_internal_chirality_switch_no_go.json")
    ...
    checks = {
        ...
        "pass1029_forbids_internal_orientation_reversal": (
            determinant_no_go["exact_linear_algebra"]["antipodal_determinant"] == 1
            and determinant_no_go["group_theoretic_argument"]["conclusion"].startswith("det(K)=+1")
        ),
    }
    ...
    result = {
        ...
        "combined_no_go": {
            "pass1029": "Sp(4,3) contains no determinant-minus-one chirality switch",
            "pass1030": "the raw 80-vertex Levi carrier has the wrong orbit structure",
            "architectural_consequence": (
                "a chirality controller must be an external extension acting above "
