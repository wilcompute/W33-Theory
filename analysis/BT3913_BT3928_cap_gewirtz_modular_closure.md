# Passes 3913–3928 — cap endpoint pressure, Petersen switching closure, and modular extension structure

## Frozen status

```text
PASS_5_FRONTS_PLUS_3_CONSTRUCTIONS
753c9039c032574dbcf5c20b899444ccc74bd092be22646211173fbd36be9eb6
```
...
## 3913–3915 — 68-face caps and a 172-face transversal
...
## 3916–3918 — the one-defect 69 tripod
...
## 3919–3921 — Petersen-blow-up association scheme
...
## 3922–3923 — exhaustive twin-class Seidel switching
...
## 3924–3925 — exact trivial-factor extension pattern in the 115-module
...
## 3926 — whitened W33 fibre-orbit frame
...
## 3928 — four constant-weight orbit codes
