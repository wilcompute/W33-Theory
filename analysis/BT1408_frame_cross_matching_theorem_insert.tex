...
$226800$ distinct such covers are certified. No cover is $\Aut$-invariant, since
$\Aut$ is transitive on the $540$ frames and a cover uses $60$. Cover stabilisers
have order $2$, $4$ or $8$ (types $C_2$, $C_4$, $C_2\times C_2$, $C_4\times C_2$,
$D_8$), so a cover is close to rigid --- but the residual symmetry is \emph{not}
uniformly diagonal: a $C_2$-stabilised cover fixes twelve of its sixty frames
(orbit profile $1^{12}2^{24}$), whereas the $C_4$ covers fix none.
\end{proposition}
