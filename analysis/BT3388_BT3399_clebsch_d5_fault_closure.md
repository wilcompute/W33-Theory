...
## 3388 — edge-dependent magnetic audit beyond the three-cone compiler
...
## 3389 — independent nonlinear witness and minimum linear all-word code
...
## 3390 — post-fault symbolic remapping with six fixed spares
...
## 3391 — gauge-defect fusion algebra
...
## 3392 — complete triple-fault census and the Q6 boundary
...
## 3393 BONKERS — the flat sector is an \(A_2\) flux crystal
...
## 3394 BONKERS — a moving folded-cube quotient atlas
