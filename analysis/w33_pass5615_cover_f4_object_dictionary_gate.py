...
def main():
    ...
    if not cover_cert.exists() or not f4_cert.exists():
        ...
        # Producer contract: cover12_to_latin is a zero-based list on the moving orbit.
        cl=list(map(int,c['cover12_to_latin']))
