...
def verify_basic():
 ...
 for p in ('2','3','5'):
  ...
  assert q['radical_layers']==e['radical_layers'];assert q['socle_layers']==e['socle_layers'];assert q['resolution_depth']==10
  ...
  assert len(q['minimal_projective_resolution_prefixes'])==len(e['vertices']);out[p]={'basic_dimension':r['basic_algebra_dimension'],'quiver':r['quiver_and_associated_graded_relations'],'projective_layers':e,'literal_resolution_prefixes':q['minimal_projective_resolution_prefixes']}
 return out
def verify_atlas():
