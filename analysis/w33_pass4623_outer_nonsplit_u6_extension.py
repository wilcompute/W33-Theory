#!/usr/bin/env python3
"""Pass 4623 bonkers -- PGSp outer symmetry glues the multiplicity-two U6 nonsplit."""
from __future__ import annotations
import json
from pathlib import Path
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'data/PART_W33_PASS4623_OUTER_NONSPLIT_U6_EXTENSION.json'
def main():
    d=json.loads((ROOT/'data/PART_W33_PASS4618_OUTER_CANONICAL_U6_FACTOR.json').read_text())
    ...
    out={'pass':4623,'module':'Q12=K27/K15','restriction_to_PSp':'U6 direct-sum U6','PSp_invariant_six_submodules':3,
