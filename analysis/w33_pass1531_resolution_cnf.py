...
def generate(path:Path):
    ...
    return {'schema':'w33.pass1531.resolution_cnf.v1','status':'PASS','variables':4860,'clauses':99909,'bytes':len(text.encode()),'sha256':hashlib.sha256(text.encode()).hexdigest(),'symmetry_break_edge':0,'symmetry_break_frames':edge_frames[0]}
