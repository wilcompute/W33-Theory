# The two 36-state Hesse carriers separate exactly at the qutrit order-three class
...
| element order | class size | ordinary Hesse 36 | compiler-safe 36 |
|---:|---:|---:|---:|
| 1 | 1 | 36 | 36 |
| 2 | 1 | 12 | 12 |
| 3 | 8 | 3 | 9 |
...
Thus the characters agree everywhere except the order-three class.

\[
\boxed{\chi_{\rm ordinary}-\chi_{\rm safe}
\text{ is supported only on the qutrit order-3 shear class}.}
\]
...
common-\(SL(2,3)\) non-equivalence and pinpoints its order-three defect. It does
