...
if len(orbit) == 40:
    print("✓ TRANSITIVE ACTION: The triflection group acts transitively on all 40 states!")
else:
...
for i, R in enumerate([R1, R2, R3, R4], 1):
    ...
    if perm is not None:
        ...
        print(f"  R{i} induces permutation with cycle type: {sorted(cycles, reverse=True)}")
    else:
