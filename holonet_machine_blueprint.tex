...
\date{\normalsize 3 August 2026 \quad$\cdot$\quad Passes 2700--2783}
...
Time reversal outer $\iff q\equiv 3\pmod 4$ & proved & Pass 2750, $q\le 23$\\
...
\item \textbf{The transpose construction is verified at $q=3$ only.} The
      $q\equiv 3\pmod 4$ statement is the quadratic-residue fact plus that
      identification; it has not been re-derived at larger $q$.
\item \textbf{One original module is unparseable and remains so.}
      \cmd{rtl/w33\_spread\_mixer36.sv} is rejected by both frontends. We added a port
      rather than editing another track's file; the original should be retired.
\end{enumerate}
