...
\date{\normalsize 3 August 2026 \quad$\cdot$\quad Passes 2700--2802}
...
\begin{spec}[The two engines, measured in one harness]
\begin{center}\small
\begin{tabular}{@{}lrrrl@{}}
\toprule
...
Minimal engine: $\mathbf{43}$ LC, $\mathbf{72.40}$\,MHz & \textbf{measured} & Pass 2796\\
