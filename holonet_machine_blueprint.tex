...
\date{\normalsize 3 August 2026 \quad$\cdot$\quad Passes 2700--2869}
...
transformations, with a worst-case program length of exactly \textbf{19}. The arithmetic
core fits in \textbf{43 logic cells} on a \$25 chip and runs at \textbf{208.9\,MHz} ---
measured, not estimated. A support readout erases exactly $8/3$ of a bit, so its energy
cost is fixed by thermodynamics rather than by engineering. The physical layer is a
photonic gate a laboratory has already demonstrated at $0.92$ fidelity. And thirty-six of
...
\begin{spec}[The coincidence, and what is and is not claimed]
\[
...
\smallskip\noindent
\textbf{Not claimed:} a canonical isomorphism between the frame space and the homology.
The counts agree and the reason they agree is understood; a natural map between them is a
