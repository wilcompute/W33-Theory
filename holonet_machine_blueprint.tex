...
\date{\normalsize 3 August 2026 \quad$\cdot$\quad Passes 2700--2886}
...
\item \textbf{Two of the eight opcodes are not frame operations, and are not built as
      such.} $D_{12}$-mirror is a transport operation in a dihedral group and has no
      register semantics, so there is nothing for the frame engine to do with it.
...
\item \textbf{A power figure exists, and it is modelled, not measured.} This item used to
      ...
      \item \textcolor{bad}{\textbf{Modelled:}} $0.502$\,pJ per operation and
            $0.105$\,mW at $208.86$\,MHz, from measured activity ($1.622$ transitions/op),
            measured cell count ($43$) and \emph{assumed} $5$\,fF/cell and $1.2$\,V.
