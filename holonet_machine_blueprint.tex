...
\date{\normalsize 3 August 2026 \quad$\cdot$\quad Passes 2700--2837}
...
genuinely in doubt. Making it practical needs a branch with super-linear convergence, or
a portfolio composing several of the $48$. This document reports the honest state of that:
one improving map, quantified, and a clear statement of what would have to be found next.
\end{plain}
...
py -3 analysis/w33\_pass2797\_2799\_magic\_orbits\_and\_monotone.py\\[4pt]
