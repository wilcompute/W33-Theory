...
SCRIPT = ROOT / "analysis" / "w33_pass2690_integer_transceiver_reference.py"
DATA = ROOT / "data" / "w33_pass2690_2695_incidence_transceiver.json"
RTL = ROOT / "rtl" / "w33_pass2691_incidence_transceiver.sv"
EXPECTED_SHA = "32abd65ffe1dd348148a3d9600b4b4927ae0209db2599517321e29827a722edc"


def load_module():
    spec = importlib.util.spec_from_file_location("w33_pass2690", SCRIPT)
...
def test_rtl_masks_match_exact_geometry() -> None:
    ...
    assert "module w33_pass2691_incidence_core" in text
    assert "module w33_pass2691_incidence_serial" in text
