...
CERT=ROOT/'data'/'w33_pass1521_1525_frame_resolution_continuation.json'
...
def test_release_status_and_boundaries():
 ...
 assert c['pass1521_resolution_cnf']['status']=='FORMULATED_OPEN'
 assert c['pass1521_resolution_cnf']['variables']==4860
 assert c['pass1521_resolution_cnf']['clauses']==99909
 assert c['pass1523_cover_frontier_audit']['frozen_frontier']['certified_cover_lower_bound']==3547800
 assert 'not a global completeness theorem' in c['pass1523_cover_frontier_audit']['boundary']
def test_module_and_bridge_dimensions():
 c=load();m=c['pass1522_module_fingerprint'];b=c['pass1525_frame_harmonic_bridge']
...
def test_four_packing_affine_shell():
 c=load()['pass1524_four_packing_simplex'];assert c['status']=='PASS'
