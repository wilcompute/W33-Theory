...
def test_pass1223_sign_twist_intertwiner():
    d=load('w33_pass1223_81_sign_twist_intertwiner.json')
...
def test_pass1224_matrix_units():
    d=load('w33_pass1224_m3_m21_matrix_units.json')
    assert d['status']=='PASS'
...
def test_pass1225_hecke_equality():
    d=load('w33_pass1225_a5_s5_hecke_equality.json')
    assert d['status']=='PASS'
...
def test_pass1226_literal_cycle_frontier():
    d=load('w33_pass1226_literal_cycle_orbits_7_8.json')
    assert d['status']=='PASS'
...
def test_pass1227_triality_boundary():
    d=load('w33_pass1227_a2_normalizer_triality.json')
    assert d['status']=='PASS'
