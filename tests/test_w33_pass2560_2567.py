...
def test_breakthrough_boundaries():
 u=json.loads((ROOT/'data/w33_pass2560_u6_singleton_orbit_harvest.json').read_text());f=json.loads((ROOT/'data/w33_pass2562_exact_character_fusion.json').read_text());s=json.loads((ROOT/'data/w33_pass2565_abstract_schlaefli_incidence.json').read_text());assert u['orbit_classification']['certified_singleton_lower_bound']==13633920;assert f['exact_submodule_assignment']['135']=='60+15+30+30';assert s['line_graph']['parameters']==[27,10,1,5]
