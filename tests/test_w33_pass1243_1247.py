...
def test_pass1243_sign_twist_intertwiner():
    d=load('w33_pass1243_81_sign_twist_intertwiner.json')
...
def test_pass1244_matrix_units():
    d=load('w33_pass1244_m3_m21_matrix_units.json')
    assert d['status']=='PASS'
...
def test_pass1245_hecke_equality():
    d=load('w33_pass1245_a5_s5_hecke_equality.json')
    assert d['status']=='PASS'
...
def test_pass1246_literal_cycle_frontier():
    d=load('w33_pass1246_literal_cycle_orbits_7_8.json')
    assert d['status']=='PASS'
...
def test_pass1247_triality_boundary():
    d=load('w33_pass1247_a2_normalizer_triality.json')
    assert d['status']=='PASS'
