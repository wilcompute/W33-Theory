...
def test_boundaries_and_key_values():
    ...
    d66=json.loads((r/'data/w33_pass1966_combined_spread_signature_geometry.json').read_text())
    d68=json.loads((r/'data/w33_pass1968_internal_mu6_structural_role.json').read_text())
    d69=json.loads((r/'data/w33_pass1969_backward_constraint_audit.json').read_text())
