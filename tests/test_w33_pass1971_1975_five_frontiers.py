...
def test_boundaries_and_corrections():
    ...
    d71=json.loads((root/'data/w33_pass1971_spread_treatments_concordance.json').read_text())
    d72=json.loads((root/'data/w33_pass1972_scalable_constraint_audit.json').read_text())
    d73=json.loads((root/'data/w33_pass1973_solver_stagnation_diagnosis.json').read_text())
    d74=json.loads((root/'data/w33_pass1974_uniform_spread_proofs.json').read_text())
    d75=json.loads((root/'data/w33_pass1975_claim_ledger_physics_engineering.json').read_text())
