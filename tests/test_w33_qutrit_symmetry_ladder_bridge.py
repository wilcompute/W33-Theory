...
def test_qutrit_symmetry_ladder_dictionary_is_exact() -> None:
    ...
    assert ladder["exact_factorizations"]["projective_order_factorization"] == "25920 = 40 * 648 = 240 * 108"
    assert ladder["exact_factorizations"]["full_order_factorization"] == "51840 = 2 * 25920 = 40 * 1296 = 240 * 216"
    assert ladder["exact_factorizations"]["neighbor_action_factorization"] == "432 = 9 * 48"
    assert ladder["exact_factorizations"]["point_stabilizer_factorization"] == "1296 = 2 * 648"
