...
def test_bt1212_materialized_tables():
    t1208 = json.loads((ROOT / 'data' / 'PART_BT1208_RAW_Z2_S3_CONTINGENCY_TABLE_results.json').read_text())
    ...
    t1209 = json.loads((ROOT / 'data' / 'PART_BT1209_ISOMORPHISM_DEPENDENCE_SAMPLE_results.json').read_text())
...
def test_bt1212_schema_materialized():
    schema = json.loads((ROOT / 'data' / 'PART_BT1210_BT748_HALF_FIBER_TABLE_SCHEMA.json').read_text())
