...
def test_exact_semantic_certificate():
 ...
 observed=module.build();frozen=json.loads((ROOT/'data'/'PART_3837_3854_OVOID_WEDDERBURN_CODE_LEECH_TRIALITY_results.json').read_text(encoding="utf-8"))
...
def test_independent_graph_certificate():
 ...
 observed=module.build();frozen=json.loads((ROOT/'data'/'PART_3837_3854_GRAPH_AUT_CERTIFICATE.json').read_text(encoding="utf-8"))
 assert observed==frozen
...
def test_claim_boundaries_and_pending_monster_slot():
 frozen=json.loads((ROOT/'data'/'PART_3837_3854_OVOID_WEDDERBURN_CODE_LEECH_TRIALITY_results.json').read_text(encoding="utf-8"))
 candidate=json.loads((ROOT/'data'/'PART_3837_3854_MONSTER_DESCENT_candidate.json').read_text(encoding="utf-8"))
