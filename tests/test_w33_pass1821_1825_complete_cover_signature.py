...
def test_frozen_complete_cover_signature_certificate():
 p=json.loads((ROOT/'data'/'w33_pass1821_1825_complete_cover_signature.json').read_text())
 ...
 q=json.loads(gzip.decompress(base64.b64decode((ROOT/'data'/'w33_pass1825_signatures720.json.gz.b64').read_text())).decode())
