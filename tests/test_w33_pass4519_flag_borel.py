...
def test_flag_is_exact_sylow3_normalizer_borel():
    d=json.loads((ROOT/'data/PART_W33_PASS4519_FLAG_BOREL_SYLOW3_NORMALIZER.json').read_text())
    assert d['pass']==4519
...
def test_borel_statement_is_chained_and_public():
    chain=(ROOT/'analysis/PASS4503_4510_apartment_obstruction_scaling_insert.tex').read_text()
    ...
    card=(ROOT/'analysis/PASS4503_4510_apartment_obstruction_scaling_index_insert.html').read_text()
