...
W(E6) acts on (Z/2)^8 preserving the quadratic form.
The orbits should be {1} + {135} + {120} -- three orbits total.
We verify this and compute the orbit stabilizer sizes.
...
# W(E6) order = 51840. Under O+(8,2), W(E6) preserves the form.
# W(E6) acts transitively on each of {isotropic}, {anisotropic} (by O+(8,2) transitivity)
# Stabilizer sizes:
stab_iso = 51840 // 135
...
synthesis = {
    ...
    "verdict": "COMPLETE: The 255 discriminant cosets of Lambda_C decompose as {1}+{135}+{120} under W(E6). The anisotropic 120-orbit = 240 E8 roots/pm1 = W(3,3) edges. The isotropic 135-orbit = O+(8,2) polar graph vertices. The E6/E8 confluence is arithmetically complete."
}
