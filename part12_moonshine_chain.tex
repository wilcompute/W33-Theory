...
% ═══════════════════════════════════════════════════════════════
\clearpage
\part{\texorpdfstring{The Moonshine Chain: From W(3,3) to the $j$-Function}{The Moonshine Chain: From W(3,3) to the j-Function}}
...
\section{\texorpdfstring{Leech Lattice: $196560 = E\cdot q^2\cdot\Phisix\cdot\Phithree$}{Leech Lattice: 196560 = E times q-squared times Phi6 times Phi3}}
...
\section{\texorpdfstring{The $j$-Function Coefficients}{The j-Function Coefficients}}
...
\section{\texorpdfstring{Ramanujan's $\tau$-Function}{Ramanujan's tau-Function}}
...
\section{\texorpdfstring{$E_8$ Theta Function}{E8 Theta Function}}
