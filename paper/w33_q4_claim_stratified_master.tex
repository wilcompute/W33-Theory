...
\[
 n=32,\qquad \operatorname{rank}(H_X)=15,\qquad \operatorname{rank}(H_Z)=13,\qquad k=4.
\]
...
\claim{SIM}{The Hashimoto falsifier observables are}
\[
\phi_1=63.43^\circ,\qquad \phi_2=112.21^\circ,
\]
plus flat-band localization, CSS logical-error proxy, and period-6 closure-clock recurrence.
