...
This is an exact bounded scalar-polynomial route, but the individual QSP phase
angles still need to be synthesized before hardware execution.
...
\]
Thus full symmetry averaging erases the chosen bridge basis but preserves its
oriented $H_1$ trace as isotropic density.  This reconciles the support-twirl and
subspace-twirl stories.
...
routing, and phase-precision budgets are applied, falsifies the projector version
of the clock--matter resonance.  (Witnesses:
...
\texttt{analysis/bt1680\_analytic\_sup\_norm\_certificate.py}, and
\texttt{analysis/bt1681\_oriented\_bridge\_projector\_twirl.py}.)
