...
print(f"    m_ν ~ v² / M_GUT = {m_nu_seesaw_simple:.3e} GeV = {m_nu_seesaw_simple * 1e9:.3f} eV")
print()
...
print(f"    M_R = M_GUT × (133[E7a]/40[pts]) = {M_GUT:.0e} × {E7_adj/PTS:.2f} = {M_R_W33:.2e} GeV")
...
print("  │                                                                   │")
print(f"  │   m₁ = {m1_W33*1000:.2f} meV                                              │")
print(f"  │   m₂ = {m2_W33*1000:.2f} meV                                              │")
print(f"  │   m₃ = {m3_W33*1000:.2f} meV                                              │")
print("  │                                                                   │")
print(f"  │   Σm_ν = {sum_masses*1000:.1f} meV < 120 meV bound ✓                         │")
print("  └" + "─" * 68 + "┘")
print()
...
print("  │                                                                   │")
print(f"  │   θ₁₂ = arcsin(√(27/81)) = {theta12_W33:.1f}° (exp: {theta12_exp}°)              │")
print(f"  │   θ₂₃ = arctan(√(40/40)) = {theta23_W33:.0f}° (exp: {theta23_exp}°)               │")
print(f"  │   θ₁₃ = arcsin(√(3/211)) = {theta13_W33:.1f}° (exp: {theta13_exp}°)              │")
print("  │                                                                   │")
...
print("  │                                                                   │")
print(f"  │   δ_CP = π + arcsin(27[E6f]/133[E7a]) = {np.degrees(delta_refined):.0f}°                │")
print("  │                                                                   │")
print(f"  │   Experimental: δ_CP = {delta_CP_exp}°                                   │")
print(f"  │   Agreement: {abs(np.degrees(delta_refined) - delta_CP_exp):.1f}°                                            │")
print("  │                                                                   │")
...
m_bb = abs(U_e1_sq * m1_W33 + U_e2_sq * m2_W33 * np.exp(1j*alpha21_W33) 
...
print(f"  │   m_ββ ~ {m_bb*1000:.1f} meV (testable by next-gen 0νββ experiments)        │")
print("  └" + "─" * 68 + "┘")
print()
...
print("│ MASSES                                                                   │")
print("├─────────────────┼────────────────────────────────┼───────────┼───────────┤")
print(f"│ m₁ [meV]        │ m₃ × √(40/81) × √(81/121)      │ {m1_W33*1000:.2f}     │ < 100     │")
print(f"│ m₂ [meV]        │ m₃ × √(81/121)                 │ {m2_W33*1000:.2f}     │ ~8.6      │")
print(f"│ m₃ [meV]        │ √(Δm²_atm)                     │ {m3_W33*1000:.2f}     │ ~50       │")
print(f"│ Σm_ν [meV]      │ m₁ + m₂ + m₃                   │ {sum_masses*1000:.1f}      │ < 120     │")
print("├─────────────────┼────────────────────────────────┼───────────┼───────────┤")
print("│ MIXING ANGLES                                                            │")
print("├─────────────────┼────────────────────────────────┼───────────┼───────────┤")
print(f"│ θ₁₂ [°]         │ arcsin(√(27/81))               │ {theta12_W33:.2f}     │ {theta12_exp}      │")
print(f"│ θ₂₃ [°]         │ arctan(√(40/40)) = 45          │ {theta23_W33:.0f}        │ {theta23_exp}       │")
print(f"│ θ₁₃ [°]         │ arcsin(√(3/211))               │ {theta13_W33:.2f}      │ {theta13_exp}       │")
print("├─────────────────┼────────────────────────────────┼───────────┼───────────┤")
print("│ CP VIOLATION                                                             │")
print("├─────────────────┼────────────────────────────────┼───────────┼───────────┤")
print(f"│ δ_CP [°]        │ π + arcsin(27/133)             │ {np.degrees(delta_refined):.0f}       │ {delta_CP_exp}       │")
print("├─────────────────┼────────────────────────────────┼───────────┼───────────┤")
print("│ NATURE                                                                   │")
print("├─────────────────┼────────────────────────────────┼───────────┼───────────┤")
print("│ Type            │ Majorana (seesaw required)     │ Majorana  │ unknown   │")
print(f"│ m_ββ [meV]      │ |Σ U²_ei m_i|                  │ {m_bb*1000:.2f}      │ < 100     │")
