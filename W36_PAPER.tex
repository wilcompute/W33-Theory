...
$\{12,\,2,\,-4\}$ with multiplicities $\{1,\,27,\,12\}$. From these six
integers alone we recover:
...
\begin{figure}[H]
  ...
  \caption{The $\W$ eigenvalue spectrum.
    ...
    $\lambda_2 = +2$ (quark--lepton sector, $\times 27$, matching
    $\dim\mathbf{27}$ of $\Esix$),
    and $\lambda_3 = -4$ (SM gauge bosons, $\times 12$,
    $= 8g + 3W + \gamma$).
...
\begin{figure}[H]
  ...
  \caption{Spectral sector decomposition of $\W$.
    The 40 degrees of freedom decompose as
    $1 + 27 + 12 = 40$ (spectral completeness $\checkmark$),
    matching the gravity singlet ($\lambda=12$),
    the $\mathbf{27}$ of $\Esix$ ($\lambda=+2$),
    and the 12 SM gauge bosons ($\lambda=-4$) respectively.}
