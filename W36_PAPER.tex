...
\begin{itemize}
  ...
  \item Chromatic number: the fractional chromatic number is
        ...
        $4 \le \chi(\W) \le 6$ (with $\chi(\W) \in \{4,5,6\}$ to be determined).
...
and $\chi(\W)$ is integer, we have $\chi(\W) \in \{4,5,6\}$. The actual value requires
explicit construction or algorithmic determination.
\end{proof}
