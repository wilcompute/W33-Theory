...
J_exp = c12_exp * c23_exp * c13_exp**2 * s12_exp * s23_exp * s13_exp * math.sin(delta_exp)
...
print(f"  1/240 = {ratio_1_240:.5f} (error: {abs(ratio_1_240 - s13_exp)/s13_exp*100:.1f}%)")
print(f"  1/270 = {ratio_1_270:.5f} (error: {abs(ratio_1_270 - s13_exp)/s13_exp*100:.1f}%)")
print(f"  4/1111 = {ratio_mu_1111:.5f} (error: {abs(ratio_mu_1111 - s13_exp)/s13_exp*100:.1f}%)")
...
J_w33 = c12_w33 * c23_w33 * c13_w33**2 * s12_w33 * s23_w33 * s13_w33 * math.sin(delta_w33)
...
J_w33_refined = c12 * c23 * c13**2 * s12_w33 * s23_w33_refined * s13_w33_refined * math.sin(delta_w33_refined)
...
results = {
    'CKM_parameters': {
        ...
        'delta_deg': {'formula': 'arctan(40/15)', 'value': delta*180/math.pi, 'exp': 68.75}
    },
    'Jarlskog_invariant': {
        'W33': J_w33_refined,
        'experimental': J_exp,
