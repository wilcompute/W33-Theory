// Pass 2717 -- exact multiplier-free digital form of the W(3,3) incidence transceiver.
//
...
module w33_pass2717_incidence_core #(
    ...
    initial begin
        if (OW < W + 7)
            $error("w33_pass2717_incidence_core requires OW >= W+7");
    end
endmodule


module w33_pass2717_incidence_serial #(
    parameter integer W = 8,
    parameter integer OW = W + 7,
    parameter bit REVERSE = 1'b0
) (
