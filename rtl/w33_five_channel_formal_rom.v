...
module w33_five_channel_symbol_rom (
    ...
    always @* begin
        case ({zero_mask, row, col})
            ...
            9'b001000000: weight = -5'sd1;
            9'b001000001: weight = 5'sd4;
            9'b001000010: weight = -5'sd2;
            9'b001000011: weight = 5'sd0;
            9'b001000100: weight = 5'sd0;
            9'b001001000: weight = 5'sd2;
            ...
            9'b001010010: weight = -5'sd2;
            9'b001010011: weight = 5'sd4;
            9'b001010100: weight = 5'sd0;
            9'b001011000: weight = 5'sd0;
            9'b001011001: weight = -5'sd1;
            9'b001011010: weight = 5'sd2;
            ...
            9'b011000000: weight = -5'sd1;
            9'b011000001: weight = 5'sd4;
            9'b011000010: weight = 5'sd4;
            9'b011000011: weight = 5'sd0;
            9'b011000100: weight = 5'sd0;
            9'b011001000: weight = 5'sd2;
            ...
            9'b011010010: weight = 5'sd1;
            9'b011010011: weight = 5'sd4;
            9'b011010100: weight = 5'sd0;
            9'b011011000: weight = 5'sd0;
            9'b011011001: weight = 5'sd2;
            9'b011011010: weight = 5'sd2;
            9'b011011011: weight = 5'sd3;
            ...
            9'b011100100: weight = -5'sd5;
            9'b100000000: weight = 5'sd2;
            9'b100000001: weight = -5'sd2;
            9'b100000010: weight = -5'sd2;
            9'b100000011: weight = 5'sd0;
            9'b100000100: weight = 5'sd0;
            9'b100001000: weight = -5'sd1;
            9'b100001001: weight = 5'sd1;
            ...
            9'b100010010: weight = 5'sd1;
            9'b100010011: weight = -5'sd2;
            9'b100010100: weight = 5'sd0;
            9'b100011000: weight = 5'sd0;
            9'b100011001: weight = -5'sd1;
            9'b100011010: weight = -5'sd1;
            9'b100011011: weight = 5'sd0;
            ...
            9'b110000000: weight = 5'sd2;
            9'b110000001: weight = -5'sd2;
            9'b110000010: weight = 5'sd4;
            9'b110000011: weight = 5'sd0;
            9'b110000100: weight = 5'sd0;
            9'b110001000: weight = -5'sd1;
            9'b110001001: weight = 5'sd1;
            ...
            9'b110010010: weight = 5'sd4;
            9'b110010011: weight = -5'sd2;
            9'b110010100: weight = 5'sd0;
            9'b110011000: weight = 5'sd0;
            9'b110011001: weight = 5'sd2;
            9'b110011010: weight = -5'sd1;
            9'b110011011: weight = 5'sd3;
