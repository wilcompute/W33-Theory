...
\begin{definition}
The W(3,3) configuration (also called the Witt configuration) is defined as the configuration of external points with respect to an oval in the projective plane PG(2,3).
\end{definition}
