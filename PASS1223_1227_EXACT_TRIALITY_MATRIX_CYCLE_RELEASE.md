# Passes 1223–1227 — Exact Triality, Matrix-Unit, and Cycle Release
...
## Pass 1223 — The \(81_+\)/\(81_-\) physical-sector bridge
...
## Pass 1224 — Actual \(M_3\) and \(M_{21}\) matrix units
...
## Pass 1225 — Equality of the two degree-432 Hecke algebras
...
## Pass 1226 — Literal primitive cycle orbits at lengths seven and eight
...
## Pass 1227 — The normalizer triality verdict
...
```bash
PYTHONPATH=analysis python analysis/w33_pass1223_81_sign_twist_intertwiner.py
PYTHONPATH=analysis python analysis/w33_pass1224_m3_m21_matrix_units.py
PYTHONPATH=analysis python analysis/w33_pass1225_a5_s5_hecke_equality.py
PYTHONPATH=analysis python analysis/w33_pass1226_literal_cycle_orbits_7_8.py
PYTHONPATH=analysis python analysis/w33_pass1227_a2_normalizer_triality.py
pytest -q tests/test_w33_pass1223_1227.py
```
