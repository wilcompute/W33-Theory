...
lam=math.sin(math.pi/14); A5=60
Vcb=0.5*math.sqrt(24)/A5; A=Vcb/lam**2
...
PDG={"Vud":0.97373,"Vus":0.22430,"Vub":3.435e-3,"Vcd":0.22100,"Vcs":0.97500,
     "Vcb":4.08e-2,"Vtd":8.60e-3,"Vts":4.03e-2,"Vtb":0.99910}
n=sum(1 for k in CKM if abs(CKM[k]-PDG[k])/PDG[k]<0.05)
if abs(J-3.08e-5)/3.08e-5<0.05: n+=1
