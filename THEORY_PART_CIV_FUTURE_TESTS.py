...
def gravitational_wave_tests():
    ...
    # Timeline
    timeline = [
        ("LIGO O5", "2025-2027", "Factor ~3 improvement", "Testing W33 mass predictions"),
        ("LIGO O6", "2028-2030", "Factor ~5 improvement", "Stochastic background search"),
        ("Einstein Telescope", "2035+", "Factor ~10", "Definitive test of W33 GW spectrum"),
...
def complete_predictions():
    ...
    print(f"{'Parameter':<25} {'W33 Prediction':<15} {'Measured':<15} {'Year':<10} {'Status':<15}")
    print("=" * 80)
