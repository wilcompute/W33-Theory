...
def analyze_correlation():
    ...
    for z4 in range(4):
        for z3 in range(3):
            for hol in ['(2,2,2)', '(3,1,1,1)', 'identity', 'other']:
                key = (z4, z3, hol)
                count = 0
                for i, (z4_i, z3_i, hol_i) in enumerate(zip(z4_values, z3_values, hol_types)):
    ...
    count_20_total = sum(c for (z4, z3, hol), c in contingency.items() if z4==2 and z3==0)
    count_20_other = sum(c for (z4, z3, hol), c in contingency.items() if z4==2 and z3==0 and hol != '(2,2,2)')
    ...
    count_00_total = sum(c for (z4, z3, hol), c in contingency.items() if z4==0 and z3==0)
...
if __name__ == "__main__":
    ...
    df.to_csv(r"C:\Users\wiljd\OneDrive\Documents\GitHub\WilsManifold\claude_workspace\data\v23_enriched_with_quantum_numbers.csv", index=False)
