...
# Data paths
W33_RAYS = Path(r"C:\Users\wiljd\OneDrive\Documents\GitHub\WilsManifold\claude_workspace\extracted\data\data\_toe/w33_orthonormal_phase_solution_20260110/W33_point_rays_C4_complex.csv")
K4_COMPONENTS = Path(r"C:\Users\wiljd\OneDrive\Documents\GitHub\WilsManifold\claude_workspace\bundles\v13_GQ42_reconstruction\center_quad_gq42_v13\gq42_points_antipodal_pairs.csv")
V23_TRIANGLES = Path(r"C:\Users\wiljd\OneDrive\Documents\GitHub\WilsManifold\claude_workspace\data\_v23\v23\Q_triangles_with_centers_Z2_S3_fiber6.csv")
...
def compute_q45_quantum_numbers(V, k4_mapping):
    ...
    print(f"All Q45 vertices have (Z4, Z3) = (2, 0): {np.all(df_q45['z4'] == 2) and np.all(df_q45['z3'] == 0)}")
...
""")
    ...
    fiber_cols = [c for c in v23_cols if 'fiber' in c.lower() or 'rotor' in c.lower() or 'sheet' in c.lower()]
...
if __name__ == "__main__":
    ...
    # Save results
    df_q45.to_csv(r"C:\Users\wiljd\OneDrive\Documents\GitHub\WilsManifold\claude_workspace\data\q45_quantum_numbers.csv", index=False)
