...
executable witness (the BT858--895 chain); there are zero free
parameters. The remaining physics --- coupling magnitudes, mixing
angles, masses, the continuum limit --- is the established numerical
layer and is not claimed here.
\end{abstract}
...
input. Each has an executable script in \texttt{analysis/} with JSON
results in \texttt{data/}.
